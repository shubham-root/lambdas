...
impl Domain for RegexVal {
    ...
    fn new_dsl() -> DSL<Self> {
        DSL::new(
            vec![
                Production::func("fix1", "t0 -> ((t0 -> t1) -> t0 -> t1) -> t1", Arc::new(fix1), ordered_float::OrderedFloat(0.)),
                Production::func("fix", "((t0 -> t1) -> t0 -> t1) -> t0 -> t1", Arc::new(fix), ordered_float::OrderedFloat(0.)),
                Production::func("cons", "t0 -> list t0 -> list t0", Arc::new(cons), ordered_float::OrderedFloat(0.)),
                Production::func("car", "list t0 -> t0", Arc::new(car), ordered_float::OrderedFloat(0.)),
                Production::func("cdr", "list t0 -> list t0", Arc::new(cdr), ordered_float::OrderedFloat(0.)),
                Production::func_custom("if", "bool -> t0 -> t0 -> t0", Some(&[1, 2]), Arc::new(branch), ordered_float::OrderedFloat(0.)),
                Production::val("_rvowel", "str", Dom(Str(String::from("'[aeiou]'"))), ordered_float::OrderedFloat(0.)),
                Production::val(
                    "_rconsonant",
                    "str",
                ...
                Production::func("_emptystr", "str -> bool", Arc::new(primitive_emptystr), ordered_float::OrderedFloat(0.)),
                Production::val("_rdot", "str", Dom(Str(String::from("."))), ordered_float::OrderedFloat(0.)),
                Production::func("_rnot", "str -> str", Arc::new(primitive_rnot), ordered_float::OrderedFloat(0.)),
                Production::func("_ror", "str -> str -> str", Arc::new(primitive_ror), ordered_float::OrderedFloat(0.)),
                Production::func("_rconcat", "str -> str -> str", Arc::new(primitive_rconcat), ordered_float::OrderedFloat(0.)),
                Production::func("_rmatch", "str -> str -> bool", Arc::new(primitive_rmatch), ordered_float::OrderedFloat(0.)),
                Production::func("_rtail", "list str -> str", Arc::new(primitive_rtail), ordered_float::OrderedFloat(0.)),
                Production::func("_rflatten", "list str -> str", Arc::new(primitive_rflatten), ordered_float::OrderedFloat(0.)),
                Production::func("_rsplit", "str -> str -> list str", Arc::new(primitive_rsplit), ordered_float::OrderedFloat(0.)),
                Production::func(
                    "_rappend",
                ...
                Production::func("_rrevcdr", "list str -> list str", Arc::new(primitive_rrevcdr), ordered_float::OrderedFloat(0.)),
                Production::func("map", "(t0 -> t1) -> (list t0) -> (list t1)", Arc::new(map), ordered_float::OrderedFloat(0.)),
                Production::val("_a", "str", Dom(Str(String::from("a"))), ordered_float::OrderedFloat(0.)),
                Production::val("_b", "str", Dom(Str(String::from("b"))), ordered_float::OrderedFloat(0.)),
                Production::val("_c", "str", Dom(Str(String::from("c"))), ordered_float::OrderedFloat(0.)),
                Production::val("_d", "str", Dom(Str(String::from("d"))), ordered_float::OrderedFloat(0.)),
                Production::val("_e", "str", Dom(Str(String::from("e"))), ordered_float::OrderedFloat(0.)),
                Production::val("_f", "str", Dom(Str(String::from("f"))), ordered_float::OrderedFloat(0.)),
                Production::val("_g", "str", Dom(Str(String::from("g"))), ordered_float::OrderedFloat(0.)),
                Production::val("_h", "str", Dom(Str(String::from("h"))), ordered_float::OrderedFloat(0.)),
                Production::val("_i", "str", Dom(Str(String::from("i"))), ordered_float::OrderedFloat(0.)),
                Production::val("_j", "str", Dom(Str(String::from("j"))), ordered_float::OrderedFloat(0.)),
                Production::val("_k", "str", Dom(Str(String::from("k"))), ordered_float::OrderedFloat(0.)),
                Production::val("_l", "str", Dom(Str(String::from("l"))), ordered_float::OrderedFloat(0.)),
                Production::val("_m", "str", Dom(Str(String::from("m"))), ordered_float::OrderedFloat(0.)),
                Production::val("_n", "str", Dom(Str(String::from("n"))), ordered_float::OrderedFloat(0.)),
                Production::val("_o", "str", Dom(Str(String::from("o"))), ordered_float::OrderedFloat(0.)),
                Production::val("_p", "str", Dom(Str(String::from("p"))), ordered_float::OrderedFloat(0.)),
                Production::val("_q", "str", Dom(Str(String::from("q"))), ordered_float::OrderedFloat(0.)),
                Production::val("_r", "str", Dom(Str(String::from("r"))), ordered_float::OrderedFloat(0.)),
                Production::val("_s", "str", Dom(Str(String::from("s"))), ordered_float::OrderedFloat(0.)),
                Production::val("_t", "str", Dom(Str(String::from("t"))), ordered_float::OrderedFloat(0.)),
                Production::val("_u", "str", Dom(Str(String::from("u"))), ordered_float::OrderedFloat(0.)),
                Production::val("_v", "str", Dom(Str(String::from("v"))), ordered_float::OrderedFloat(0.)),
                Production::val("_w", "str", Dom(Str(String::from("w"))), ordered_float::OrderedFloat(0.)),
                Production::val("_x", "str", Dom(Str(String::from("x"))), ordered_float::OrderedFloat(0.)),
                Production::val("_y", "str", Dom(Str(String::from("y"))), ordered_float::OrderedFloat(0.)),
