    ...
    fn new_dsl() -> DSL<Self> {
        DSL::new(
            vec![
                ...
                Production::func("_emptystr", "str -> bool", primitive_emptystr, ordered_float::OrderedFloat(0.)),
                Production::val("_rdot", "str", Dom(Str(String::from("."))), ordered_float::OrderedFloat(0.)),
                Production::func("_rnot", "str -> str", primitive_rnot, ordered_float::OrderedFloat(0.)),
                Production::func("_ror", "str -> str -> str", primitive_ror, ordered_float::OrderedFloat(0.)),
                Production::func("_rconcat", "str -> str -> str", primitive_rconcat, ordered_float::OrderedFloat(0.)),
                Production::func("_rmatch", "str -> str -> bool", primitive_rmatch, ordered_float::OrderedFloat(0.)),
                Production::func("_rtail", "list str -> str", primitive_rtail, ordered_float::OrderedFloat(0.)),
                Production::func("_rflatten", "list str -> str", primitive_rflatten, ordered_float::OrderedFloat(0.)),
                Production::func("_rsplit", "str -> str -> list str", primitive_rsplit, ordered_float::OrderedFloat(0.)),
                Production::func(
                    "_rappend",
                ...
                Production::func("_rrevcdr", "list str -> list str", primitive_rrevcdr, ordered_float::OrderedFloat(0.)),
